...
namespace easy 
{
  namespace windows 
  {
    ...
    public:
      ...
      //! Retrieves an expanded variable 
      std::wstring get_expanded_value(error_code_ref ec = nullptr) const;
    ...
    namespace api
    {
      ...
      std::wstring expand_environment_variable(const lite_wstring& value, error_code_ref ec = nullptr);
    }
